...
<div class='main-content-inner'>
					<div class='breadcrumbs ace-save-state' id='breadcrumbs'>
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<form class="form-horizontal" role="form" action="proses_tambah_pembayaran.php" method="post" enctype="multipart/form-data">
									<div class="form-group">
										<label class="col-sm-2 control-label no-padding-right" for="form-field-1-1"> NIS </label>

										<div class="col-sm-6">
											<input type="text" id="form-field-1-1" name="nis" placeholder="Masukkan NIS" class="form-control" />
										</div>
									</div>
									<div class="form-group">
